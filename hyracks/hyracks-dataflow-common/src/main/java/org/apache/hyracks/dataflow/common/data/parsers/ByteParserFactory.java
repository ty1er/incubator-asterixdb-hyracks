            ...
            public void parse(char[] buffer, int start, int length, DataOutput out) throws HyracksDataException {
                    ...
                    switch (ch) {
                        ...
                        default:
                            ...
                            throw new HyracksDataException(
                                    "Byte Parser - a digit is expected. But, encountered this character: " + ch
                ...
                for (; i < length; ++i) {
                    ...
                    switch (ch) {
                        ...
                        default:
                            String errorString = new String(buffer, i + start, length - i);
                            throw new HyracksDataException("Byte Parser - a whitespace, tab, new line, or "
