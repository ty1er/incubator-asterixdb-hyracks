...
public class LSMTreeIndexInsertUpdateDeleteOperatorDescriptor extends AbstractTreeIndexOperatorDescriptor {
    ...
    public LSMTreeIndexInsertUpdateDeleteOperatorDescriptor(IOperatorDescriptorRegistry spec, RecordDescriptor recDesc,
            ...
            IStatisticsManagerProvider statsManagerProvider, IFileSplitProvider fileSplitProvider, ITypeTraits[] typeTraits,
        ...
        super(spec, 1, 1, recDesc, storageManager, lifecycleManagerProvider, statsManagerProvider, fileSplitProvider, typeTraits,
