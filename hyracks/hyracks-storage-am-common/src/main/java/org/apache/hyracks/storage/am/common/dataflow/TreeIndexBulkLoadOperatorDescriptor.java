...
public class TreeIndexBulkLoadOperatorDescriptor extends AbstractTreeIndexOperatorDescriptor {
    ...
    public TreeIndexBulkLoadOperatorDescriptor(IOperatorDescriptorRegistry spec, RecordDescriptor recDesc,
            ...
            boolean checkIfEmptyIndex, IIndexDataflowHelperFactory dataflowHelperFactory) {
        super(spec, 1, 1, recDesc, storageManager, lifecycleManagerProvider, statsManagerProvider, fileSplitProvider,
                typeTraits, comparatorFactories, bloomFilterKeyFields, dataflowHelperFactory, null, false, false, null,
